...
const Footer = () => {
  return (
    <div id="works" className=" mx-auto m-auto h-[300px]  mt-16 sm:h-[250px] ">
      ...
      <div className="bg-gradient-to-r from-purple-400 to-red-500 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        <h2
          data-aos="zoom-out"
        ...
        <div className=" flex items-center justify-center gap-8 sm:gap-5">
          ...
          <a
            ...
            href="https://api.whatsapp.com/send?phone=56973390169&text=Hola%21+Estuve+mirando+su+portfolio%2C+me+presento%3A+"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
